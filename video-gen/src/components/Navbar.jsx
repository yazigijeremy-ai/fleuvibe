        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-accent hover:bg-accent-hover text-white text-xs font-semibold transition-all glow-accent-sm"
            >
              <User size={12} />
              Connexion
            </button>
