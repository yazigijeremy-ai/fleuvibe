    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="bg-surface-1 border border-white/10 rounded-2xl w-full max-w-sm p-6 space-y-5 relative">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center glow-accent-sm">
          ...
          <p className="text-xs text-white/40">
            {mode === 'signin' ? 'Retrouve tes vidéos générées' : 'Sauvegarde toutes tes créations'}
          </p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all text-sm font-medium text-white/70 hover:text-white"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2.5 rounded-xl bg-accent hover:bg-accent-hover text-white font-semibold text-sm flex items-center justify-center gap-2 disabled:opacity-50 transition-all glow-accent-sm"
          >
